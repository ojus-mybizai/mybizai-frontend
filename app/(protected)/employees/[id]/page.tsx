                    ...
                    <div className="divide-y divide-border-color">
                      {bizActivity.map((item) => {
                        const ACTION_ICONS: Record<string, string> = {
                          ...
                          lead_updated: '✏️',
                          lead_assigned: '👤',
                          datasheet_record_created: '➕',
                          datasheet_record_updated: '📊',
                          datasheet_record_deleted: '🗑️',
                          work_started: '▶️',
                          work_completed: '✅',
                          work_form_submitted: '📋',
                          work_step_completed: '☑️',
                          work_record_done: '✔️',
                        };
                        const ACTION_LABELS: Record<string, string> = {
                          ...
                          datasheet_record_created: 'Created record',
                          datasheet_record_updated: 'Updated record',
                          datasheet_record_deleted: 'Deleted record',
                          work_started: 'Started work',
                          work_completed: 'Completed work',
                          work_form_submitted: 'Submitted work form',
                          work_step_completed: 'Completed step',
                          work_record_done: 'Marked record done',
                        };
                        return (

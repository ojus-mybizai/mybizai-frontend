    ...
    <div className="border border-border-color rounded-xl p-4 bg-bg-secondary/40">
      ...
      {status?.connected && (
        <>
          ...
          {lastResult && (
            <div className="text-xs text-green-800 bg-green-50 border border-green-300 rounded-lg px-3 py-2 mb-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-red-600 border border-red-300 rounded-lg hover:bg-red-50 disabled:opacity-60 transition-colors"
            >
